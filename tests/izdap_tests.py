...
class IzdapTest(unittest.TestCase):
    ...
    def test_regression_coefficient(self):
        ...
        self.assertEqual(round(IzdapAlgo().calculate_regression_coefficient(nA=200, nB=200, nAB=100, N=1000), 3), 0.375, message)
        
    def test_klosgen_measure(self):
        print(inspect.stack()[0][3])
        message = 'The klosgen measure is calculated incorrectly'
        self.assertEqual(round(IzdapAlgo().calculate_klosgen_measure(nA=200, nB=200, nAB=100, N=1000), 3), 0.134, message)
