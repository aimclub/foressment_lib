...
from foressment_ai import AIForecaster, DataScaler, ForecastEstimator
from examples.forecaster_examples import DataLoader
import unittest
import inspect
import os.path
import numpy as np
...
class TestForecaster(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        super(TestForecaster, self).__init__(*args, **kwargs)
        TestForecaster.n = 1

    def setUp(self):
        print('Test {} BEGIN'.format(TestForecaster.n))

    def tearDown(self):
        print('Test {} END'.format(TestForecaster.n))
        TestForecaster.n += 1
