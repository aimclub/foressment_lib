...
class IzdapAlgo:
    ...
    Attributes:
        ...
        __class_column: Name of column with class labels (str)
        ...
        __string_columns: String columns of the dataset (list).
        __number_columns: Numeric columns of the dataset (list).
