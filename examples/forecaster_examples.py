...
from foressment_ai import DataScaler, AIForecaster, ForecastEstimator, Logger, DataLoader
...
def example_forecaster_model_training(dataset_name, suf='', mode=1):
    """
...
def example_forecaster_forecasting(dataset_name, suf='', mode=1,
                                   train_size=0.9,
                                   independently=True,
                                   sample_type='test'):
    """
...
if __name__ == '__main__':
    ...
    for mode in range(1, 9):
        suf = '_ex1_c' + str(mode)
        example_forecaster_model_training(dataset_name, suf, mode)
        example_forecaster_forecasting(dataset_name, suf, mode, sample_type='train')
        example_forecaster_forecasting(dataset_name, suf, mode, sample_type='test')
        example_forecaster_forecasting(dataset_name, suf, mode, sample_type='test', independently=False)

    suf = '_ex1'
    dataset_name = 'hai'
    example_forecaster_model_training(dataset_name, suf)
    example_forecaster_forecasting(dataset_name, suf, sample_type='train')
    example_forecaster_forecasting(dataset_name, suf, sample_type='test')
    example_forecaster_forecasting(dataset_name, suf, sample_type='test', independently=False)