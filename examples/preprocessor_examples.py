...
def preprocessor_example_titanic():
    """
    Example of the Preprocessor work on the titanic dataset.
...
def preprocessor_example_basic():
    # TEST BASED ON SYNTHETIC DATA
    """
    Basic example of the Preprocessor work.
    In this example, preprocessing algorithms are applied to the generated data.
...
if __name__ == '__main__':
    ...
    # print('BASIC EXAMPLE')
    # print('===================')
    # preprocessor_example_basic()
    # print('===================')

    print('===================')
    print('TITANIC EXAMPLE')
    print('===================')
    preprocessor_example_titanic()
    print('===================\n')
